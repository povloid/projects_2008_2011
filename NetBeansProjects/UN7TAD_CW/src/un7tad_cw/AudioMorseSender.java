 ...
 */
public class AudioMorseSender {


//    public static void main(String[] args) throws IOException{
//
//        AudioMorseSender a = new AudioMorseSender();
//
//    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        as.sendMorseChars("jfwiojfwoeijfowejfoweijfowe foweijfoweijf k");
        System.exit(1);
    }
...
//			}
     ...
     */
    public void sendMorseChars(String str) throws Exception {
    ...
    protected void doSendChars(String str) throws Exception {
        str = str.toUpperCase();
        log.fine("Sending chars: " + str);
        // 10 seconds of audio
        int off = 0;
