...
<html>
    ...
    <body>
        ...
        <%
            ...
            int userAccessLevel = DataWork.getUserAccessLevel(webUserName);
        ...
        %>
        <form name="FORM_FOR_ID" action="Search.jsp" method="POST">
        ...
        %>
        <form name="FORM_FOR_KEY_WORDS" action="Search.jsp" method="POST">
            ...
            if (stype != null) {
                ...
                if (stype.equals("FOR_ID")) {
                    ...
                    if (idS != null && idS.trim().length() > 0) {
                        dwResult = DataWork.getBox(webUserName,idS);
                        rs = dwResult.getRs();
                    }
                    ...
                    if (words != null) {
                        ...
                        dwResult = DataWork.getBoxesForWords(
                                webUserName,
                                "'" + words + "'");
                        rs = dwResult.getRs();
                    }
                    ...
                    try {
                        ...
                        dwResult = DataWork.getBoxesForDates(
                                webUserName,
                                kdtype,
                                cdtype,
                                udtype,
        ...
        <table width="100%" border="0px">
            ...
            <tbody>
                ...
                <tr>
                    <td class=tbltd<%=cI%>>
                        <A href="../BoxPresent/ShowBox.jsp?id=<%=id%>" target="_blanck">
                    ...
                    <td class=tbltd<%=cI%>>
                        <a href="../BoxPresent/GetBoxFile?id=<%=id%>">
                    ...
                    <% if (request.isUserInRole("ips_dwh_edit")) {%>
                    <td class=tbltd<%=cI%>>
                        <A href="../DataWork/Operations/AddEditBox.jsp?op=edit_box&id=<%=id%>&parent=<%=parentIdS%>">
                            <img src="../resources/images/icons/edit_16.png" width="16" height="16" alt="edit_16" border="0"/>
                            Ред. 
                        </A> /
                        <A href="../DataWork/Operations/AddEditBox.jsp?op=del_box&id=<%=id%>&parent=<%=parentIdS%>">
