 ...
 */
package tradeterminal.reports.ppl_for_date;
 ...
 * @author kopychenko
 */
public class PPLForDate implements IReport {
    ...
    public JRViewer makeReport() throws Exception {
        ...
        if (d.getReturnStatus() == ADialog.RET_OK) {
            ...
            ADBProc proc = new ADBProc("rpt_ppl_for_date");
            proc.addInParametr(
            ...
            JasperReport jasperReport =
                    ...
                    getClass().getResource("/tradeterminal/reports/ppl_for_date/ppl_for_date.jrxml").openStream());
