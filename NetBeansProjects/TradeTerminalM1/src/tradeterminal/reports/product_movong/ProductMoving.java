 ...
 */
package tradeterminal.reports.product_movong;
 ...
 * @author pkopychenko
 */
public class ProductMoving implements IReport {
    ...
    public JRViewer makeReport() throws Exception {
        ...
        if (d.getReturnStatus() == ADialog.RET_OK) {
            ...
            JasperReport jasperReport =
                    ...
                    getClass().getResource("/tradeterminal/reports/product_movong/prod_obor_report.jrxml").openStream());
