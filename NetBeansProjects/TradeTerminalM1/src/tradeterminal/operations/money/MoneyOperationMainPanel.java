 ...
 * @author  PKopychenko
 */
public class MoneyOperationMainPanel extends javax.swing.JPanel
        implements IPage {
...
//        aDBJXTable.getColumnModel().removeColumn(aDBJXTable.getColumnModel().getColumn(0));
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(tradeterminal.TradeTerminalApp.class).getContext().getResourceMap(MoneyOperationMainPanel.class);
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(resourceMap.getString("jPanel1.border.title"))); // NOI18N
        jPanel1.setMinimumSize(new java.awt.Dimension(383, 119));
        jPanel1.setName("jPanel1"); // NOI18N
        jPanel1.setPreferredSize(new java.awt.Dimension(421, 120));
        ...
        currentBandSumLabel.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        currentBandSumLabel.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        currentBandSumLabel.setMaximumSize(new java.awt.Dimension(150, 50));
        currentBandSumLabel.setMinimumSize(new java.awt.Dimension(150, 32));
        currentBandSumLabel.setName("currentBandSumLabel"); // NOI18N
        currentBandSumLabel.setPreferredSize(new java.awt.Dimension(150, 32));
        ...
        totalBandSumLabel.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        totalBandSumLabel.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        totalBandSumLabel.setMaximumSize(new java.awt.Dimension(150, 50));
        totalBandSumLabel.setMinimumSize(new java.awt.Dimension(150, 32));
        totalBandSumLabel.setName("totalBandSumLabel"); // NOI18N
        totalBandSumLabel.setPreferredSize(new java.awt.Dimension(150, 32));
        ...
        jPanel4.setLayout(verticalLayout1);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(tradeterminal.TradeTerminalApp.class).getContext().getActionMap(MoneyOperationMainPanel.class, this);
