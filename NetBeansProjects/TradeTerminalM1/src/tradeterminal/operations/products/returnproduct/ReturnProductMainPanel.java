...
import tradeterminal.references_books.customers.CustomerBalanseHistoryDPanel;

/**
 *
 * @author  kopychenko
 */
public class ReturnProductMainPanel extends javax.swing.JPanel implements IPage {
...
//        }
    ...
    public void fingSellingOrder() {
        ...
        FindSellingOrder p = new FindSellingOrder();
        ...
        if (d.getReturnStatus() == ADialog.RET_OK) {
            ...
            model.findAndShowSellingOrder(p.getSelectedOrderId());
    ...
    public void enter() {
        ...
        } else if (model.executeOpertion().getResult() == 1) {
            JOptionPane.showMessageDialog(
                    this,
