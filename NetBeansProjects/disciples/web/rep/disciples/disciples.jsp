<%-- 
    Document   : disciples
    Created on : 18.10.2010, 20:01:34
    Author     : dev_sport
--%>
...
<html>
    ...
    <body>
        ...
        <n:header2 caption="Ученики" url_icon="../resources/images/icons/group_32.png"/>
        <div class="datagrid">
            <table width="100%" border="0px">
                ...
                <tbody>
                    <n:result_cycle css1="tbltd1" css2="tbltd2"
                                    columns="id;fname;iname;oname"
                                    url_rep="rep_disciple.action"
                    result="<%=DAOImpl.getDisciples()%>">
                    </n:result_cycle>
                </tbody>
            </table>
        </div>
